...
export default function BlogsAdminPage() {
  ...
  const handleChangeStatusOneblog = async (
    status: string,
    dataPath: string
  ) => {
          ...
          <Box p={3}>
            ...
            <Paper sx={{ backgroundColor: "white", p: 2 }}>
              ...
              <Box display="flex" gap={20} flexWrap="wrap">
                ...
                >
                  <Link href="/admin/blogs/trash">Thùng rác</Link>
                </Button>
                <Button
                  variant="outlined"
                  color="success"
                ...
                >
                  <Link href="/admin/blogs/create">+ Thêm mới</Link>
                </Button>
              </Box>
                    ...
                    {data.blogs.map((blog: any, index: number) => (
                      <TableRow key={blog.id}>
                        <TableCell
                          padding="checkbox"
                          onClick={(event) =>
                            handleInputChecked(event, blog.id)
                          }
                        >
                          <Checkbox />
                        </TableCell>
                        ...
                        <TableCell>
                          <div className="flex">
                            ...
                            <Tooltip
                              ...
                              onClick={() => handleDeleteOneblog(blog.id)}
                            >
