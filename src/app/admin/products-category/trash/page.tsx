...
export default function CategoriesTrashAdminPage() {
  ...
  >("info");
  const linkApi =
    "https://freshskinweb.onrender.com/admin/products/category/trash";
  ...
  const handleDeleteOnecategory = async (id: number) => {
    const confirm: boolean = window.confirm(
      "Bạn có chắc muốn xóa vĩnh viễn danh mục sản phẩm này không?"
    );
    if (confirm) {
                            ...
                            <div className="flex">
                              <Tooltip title="Khôi phục" placement="top">
                                <MdOutlineSettingsBackupRestore
                                  ...
                                  onClick={() =>
                                    handleRestoreOnecategory(category.id)
                                  }
                                />
                              </Tooltip>
                              <Tooltip
                                ...
                                onClick={() =>
                                  handleDeleteOnecategory(category.id)
                                }
                              >
