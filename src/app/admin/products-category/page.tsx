...
export default function ProductsCategoryAdminPage() {
  ...
  const handleDeleteOneProduct = async (id: number) => {
    const confirm: boolean = window.confirm(
      "Bạn có chắc muốn xóa danh mục sản phẩm này không?"
    );
    if (confirm) {
          ...
          <Box p={3}>
            ...
            <Paper sx={{ backgroundColor: "white", p: 2 }}>
              ...
              <Box display="flex" gap={20} flexWrap="wrap">
                ...
                >
                  <Link href="/admin/products-category/trash">Thùng rác</Link>
                </Button>
                <Button
                  variant="outlined"
                  color="success"
                ...
                >
                  <Link href="/admin/products-category/create">+ Thêm mới</Link>
                </Button>
              </Box>
                        ...
                        <TableRow key={category.id}>
                          ...
                          <TableCell>
                            <TextField
                              ...
                              onChange={(e) =>
                                handleChangePosition(e, category.id)
                              }
                          ...
                          <TableCell>
                            <div className="flex">
                              <Tooltip title="Chi tiết" placement="top">
                                <Link
                                  href={`/admin/products-category/detail/${category.id}`}
                                >
                              ...
                              <Tooltip
                                ...
                                onClick={() =>
                                  handleDeleteOneProduct(category.id)
                                }
                              >
