...
import { Eye, ShoppingCart, CheckCircle, MessageCircle, Banknote, ShoppingBag, User2Icon, FileText, Clock, CheckSquare } from "lucide-react";
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        setStats({
          ...data.stats,
          revenue: `${data.stats.revenue} VNĐ`, // Định dạng thành VNĐ
        });
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-white shadow-md rounded-lg p-6 h-96 overflow-y-auto">
            ...
            <table  className="w-full border-collapse border border-gray-300">
              <thead>
                <tr className="bg-blue-600 text-gray">
