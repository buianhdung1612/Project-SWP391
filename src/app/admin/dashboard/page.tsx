      ...
      wsRef.current.onmessage = (event) => {
        try {
          ...
          setStats((prevStats) => {
            ...
            return JSON.stringify(newStats) !== JSON.stringify(prevStats)
              ? newStats
              : prevStats;
          });
          ...
          if (data.top10ProductSelling) {
            setTop10ProductSelling((prevProducts) => {
              const newProducts = data.top10ProductSelling.map(
                (product: any) => ({
                ...
                <table className="w-full border border-gray-300 rounded-lg">
                  ...
                  <thead className="sticky top-0 bg-blue-600 text-white shadow-md z-20">
                    <tr>
                      ...
                      <th className="p-3  bg-blue-600 text-left">Giá</th>
                    </tr>
                  </thead>
                  <tbody>
