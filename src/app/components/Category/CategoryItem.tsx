export default function CategoryItem(props: any) {
    ...
    return (
        <>
            <div className="flex">
                <div className="border border-[1px] border-dashed border-primary rounded-tl-[15px] rounded-bl-[15px]">
                ...
                <div className="border-t border-dashed border-primary rounded-tr-[15px]">
                    <div className="w-[70px] aspect-square border-b border-r border-dashed border-primary rounded-tr-[15px]">
                        <img src={image2} className="w-full h-full object-cover" />
                    </div>
                    <div className="w-[70px] aspect-square border-b border-r border-dashed border-primary">
                        <img src={image3} className="w-full h-full object-cover" />
                    </div>
                    <div className="w-[70px] aspect-square border-b border-r border-dashed border-primary">
                        <img src={image4} className="w-full h-full object-cover" />
                    </div>
                    <div className="w-[70px] aspect-square border-b border-r border-dashed border-primary rounded-br-[15px]">
